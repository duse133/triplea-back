...
public class MakePlannerService {
    ...
    public List<TravelPlannerDTO> makePlanners(UserInputDTO userInputData){
        ...
        switch (userInputData.getArea()) {
            case "서울" -> {
                ...
                for (Seoul seoul : seoulList) {
                    points.add(new PointDTO(seoul.getLatitude(), seoul.getLongitude(), seoul.getAttractionName()));
                }
            }
            case "부산" -> {
                ...
                for (Busan busan : busanList) {
                    points.add(new PointDTO(busan.getLatitude(), busan.getLongitude(), busan.getAttractionName()));
                }
            }
            case "대구" -> {
                ...
                for (Daegu daegu : daeguList) {
                    points.add(new PointDTO(daegu.getLatitude(), daegu.getLongitude(), daegu.getAttractionName()));
                }
            }
            case "인천" -> {
                ...
                for (Incheon incheon : incheonList) {
                    points.add(new PointDTO(incheon.getLatitude(), incheon.getLongitude(), incheon.getAttractionName()));
                }
            }
            case "광주" -> {
                ...
                for (Gwangju gwangju : gwangjuList) {
                    points.add(new PointDTO(gwangju.getLatitude(), gwangju.getLongitude(), gwangju.getAttractionName()));
                }
            }
            case "대전" -> {
                ...
                for (Deajeon deajeon : deajeonList) {
                    points.add(new PointDTO(deajeon.getLatitude(), deajeon.getLongitude(), deajeon.getAttractionName()));
                }
            }
            case "울산" -> {
            ...
            case "세종" -> {
                ...
                for (Sejong sejong : sejongList) {
                    points.add(new PointDTO(sejong.getLatitude(), sejong.getLongitude(), sejong.getAttractionName()));
                }
            }
            case "경기" -> {
                ...
                for (Gyeonggido gyeonggido : gyeonggidoList) {
                    points.add(new PointDTO(gyeonggido.getLatitude(), gyeonggido.getLongitude(), gyeonggido.getAttractionName()));
                }
            }
            case "강원" -> {
                ...
                for (Gangwondo gangwondo : gangwondoList) {
                    points.add(new PointDTO(gangwondo.getLatitude(), gangwondo.getLongitude(), gangwondo.getAttractionName()));
                }
            }
            case "충북" -> {
                ...
                for (Chungbuk chungbuk : chungbukList) {
                    points.add(new PointDTO(chungbuk.getLatitude(), chungbuk.getLongitude(), chungbuk.getAttractionName()));
                }
            }
            case "충남" -> {
                ...
                for (Chungnam chungnam : chungnamList) {
                    points.add(new PointDTO(chungnam.getLatitude(), chungnam.getLongitude(), chungnam.getAttractionName()));
                }
            }
            case "전북" -> {
                ...
                for (Jeonbuk jeonbuk : jeonbukList) {
                    points.add(new PointDTO(jeonbuk.getLatitude(), jeonbuk.getLongitude(), jeonbuk.getAttractionName()));
                }
            }
            case "전남" -> {
                ...
                for (Jeonnam jeonnam : jeonnamList) {
                    points.add(new PointDTO(jeonnam.getLatitude(), jeonnam.getLongitude(), jeonnam.getAttractionName()));
                }
            }
            case "경북" -> {
                ...
                for (Gyongbuk gyongbuk : gyongbukList) {
                    points.add(new PointDTO(gyongbuk.getLatitude(), gyongbuk.getLongitude(), gyongbuk.getAttractionName()));
                }
            }
            case "경남" -> {
                ...
                for (Gyeongnam gyeongnam : gyeongnamList) {
                    points.add(new PointDTO(gyeongnam.getLatitude(), gyeongnam.getLongitude(), gyeongnam.getAttractionName()));
                }
            }
            case "제주" -> {
                ...
                for (Jeju jeju : jejuList) {
                    points.add(new PointDTO(jeju.getLatitude(), jeju.getLongitude(), jeju.getAttractionName()));
                }
            }
        }
        ...
        //사용자 입력 강도에 따라 여행지루트 갯수 조절(중간 일때는 그냥 냅둠, 약할때는 갯수 일당 4개까지, 강할때는 일당 7개 이상)
        int dayPerCount = 0;

        if(userInputData.getStrength().equals("약함")){
